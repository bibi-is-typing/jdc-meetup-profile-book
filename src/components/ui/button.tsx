  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-background hover:bg-card-hover hover:text-foreground hover:border-primary/50",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary-hover",
        ghost: "hover:bg-accent/10 hover:text-accent transition-smooth",
        link: "text-primary underline-offset-4 hover:underline",
        neon: "bg-neon-green text-pure-black hover:bg-primary-hover shadow-neon border-0",
        vibrant: "gradient-vibrant text-white hover:opacity-90 shadow-card border-0",
      },
      size: {
